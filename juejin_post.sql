...
CREATE TABLE `cache` (
  ...
  `theme` varchar(30) NOT NULL DEFAULT 'juejin',
...
INSERT INTO `cache` VALUES ('1','gmt_modified\ngmt_created','2023-02-11 21:01:43','2023-02-11 21:01:43','juejin',NULL,NULL,NULL);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='文章对应的图片资源';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tag_post` VALUES (1,1,1,'2023-01-25 17:12:04','2023-01-25 17:12:00',0),(2,1,3,'2023-01-25 17:12:06','2023-01-25 17:12:02',0),(3,2,13,NULL,'2023-02-02 22:42:31',0),(4,2,14,NULL,'2023-02-02 22:42:40',0),(5,3,2,'2023-02-02 22:45:09','2023-02-02 22:43:33',0),(6,3,16,'2023-02-02 22:45:09','2023-02-02 22:43:35',0);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='每日网站总阅读量统计';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-02-11 21:02:18
